<?php /* Smarty version 2.6.27, created on 2016-04-01 11:39:58
         compiled from customer/edit_confirm.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'customer/edit_confirm.tpl', 38, false),array('modifier', 'h', 'customer/edit_confirm.tpl', 43, false),array('modifier', 'default', 'customer/edit_confirm.tpl', 76, false),array('modifier', 'nl2br', 'customer/edit_confirm.tpl', 157, false),)), $this); ?>
...
" />
    ...
    <div id="customer" class="contents-main">
        <table class="form">
			...
			<tr>
                <th>利用者ホーム</th>
                <td><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrHome'][$this->_tpl_vars['arrForm']['home']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
</td>
            </tr>
			<tr>
                <th>介護度</th>
                <td><?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrCare'][$this->_tpl_vars['arrForm']['care']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('default', true, $_tmp, "未登録") : smarty_modifier_default($_tmp, "未登録")))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
</td>
            </tr>
            <tr>
                <th>お名前</th>
