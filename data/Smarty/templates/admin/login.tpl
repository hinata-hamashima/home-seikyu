...
<div id="login-wrap">
    ...
    <div id="login-form" class="clearfix">
        <h1><img src="<!--{$TPL_URLPATH}-->img/contents/logo.jpg" width="140" height="150" alt="EC-CUBE管理画面" /></h1>
        <div id="input-form">
...
<div id="copyright">Copyright &copy; 2000-<!--{$smarty.now|date_format:"%Y"}--> Hinata Smile Care Supporters.Inc All Rights Reserved.</div>
