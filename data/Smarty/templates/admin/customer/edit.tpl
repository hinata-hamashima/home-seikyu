    ...
    <div id="customer" class="contents-main">
        <table class="form">
			...
			<tr>
                ...
                <td>
                    <span class="attention"><!--{$arrErr.home}--></span>
                    <span <!--{if $arrErr.home != ""}--><!--{sfSetErrorStyle}--><!--{/if}-->>
                        <!--{html_radios name="home" options=$arrHome separator=" " selected=$arrForm.home}-->
                    </span>
                </td>
            </tr>
			<tr>
                <th>介護度</th>
                <td>
                    <span class="attention"><!--{$arrErr.care}--></span>
                    <select name="care" <!--{if $arrErr.care != ""}--><!--{sfSetErrorStyle}--><!--{/if}--> >
                    <option value="" selected="selected">選択してください</option>
                    <!--{html_options options=$arrCare selected=$arrForm.care}-->
                    </select>
                </td>
            </tr>
            <tr>
